...
const KnowledgeBasePage: React.FC = () => {
  ...
  useEffect(() => {
    const filtered = getFilteredArticles(articles, selectedCategory, searchQuery);
  ...
  return (
    <Layout>
      <HeroPages 
        title="BASE DE <br />CONHECIMENTO<span class='text-primary'>.</span>"
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-gilroy font-bold text-white mb-4">
              Explore Nossa <span className="text-primary">Base de Conhecimentos</span>
            </h2>
            <p className="text-white/70 max-w-3xl">
              Encontre artigos, tutoriais e guias sobre nossos serviços e soluções digitais. 
              Use os filtros abaixo para encontrar o conteúdo que você precisa.
            </p>
          </div>
