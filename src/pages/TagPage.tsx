...
const TagPage: React.FC = () => {
  ...
  useEffect(() => {
    if (tagName) {
      // Filtra artigos que contêm a tag
  ...
  return (
    <Layout>
      <HeroPages 
        title={`Artigos com a tag <br/>#${formattedTagName}<span class='text-primary'>.</span>`}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8">
              ...
              {/* Tag atual */}
              <div className="mb-8">
                <span className="bg-primary/10 text-primary text-sm font-medium px-4 py-2 rounded-full inline-flex items-center">
              ...
              {filteredArticles.length > 0 ? (
                ...
                >
                  ...
                  <p className="text-white/70 mb-4">
                    Não encontramos artigos com a tag #{formattedTagName} que correspondam aos seus critérios de busca.
                  </p>
                  <div 
